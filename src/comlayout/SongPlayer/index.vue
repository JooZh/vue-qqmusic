      ...
      <div class="player" v-show="playerState">
        ...
        <div class='play-bottom'>
          ...
          <div class='play-buttons'>
            ...
            <div class='button'>
              <div class='ls-btn loops' @click='togglePlayList'><Icon type="ios-menu-outline" /></div>
            </div>
          </div>
        </div>
        <div class="play-list" :class="{'list-show':openList}">
          ...
          <div class='play-list-container'>
            ...
            <Scroll class="scroll-layout" :data="playerList" :scrollY="true">
  ...
  methods: {
    ...
    getPlaySong (song) {
      ...
      let playImage = new Promise(resolve => {
        resolve(this.X.img(song.songImage, 2))
      })
      // 保存数据
